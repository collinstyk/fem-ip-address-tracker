    ...
    iI2BD: [
      function (require, module, exports) {
        ...
        var _App_instances,
          ...
          _App_form,
          _App_input,
          _App_displayIpAddress,
          _App_displayLocation,
          _App_displayTimezone,
          _App_displayISP,
          _App_loadMap,
          _App_getPosition,
          _App_trackIpAddress;
        class App {
          constructor(mapZoomLevel, maxZoomLevel) {
            ...
            __classPrivateFieldSet(
              this,
              _App_displayIpAddress,
              document.querySelector(".ip-address > p"),
              "f"
            );
            __classPrivateFieldSet(
              this,
            ...
            __classPrivateFieldSet(
              this,
              _App_displayTimezone,
              document.querySelector(".timezone > p"),
              "f"
            );
            __classPrivateFieldSet(
              this,
              _App_displayISP,
              document.querySelector(".isp > p"),
              "f"
            );
        ...
        (_App_map = new WeakMap()),
          (_App_icon = new WeakMap()),
          (_App_mapZoomLevel = new WeakMap()),
          (_App_maxZoomLevel = new WeakMap()),
          (_App_form = new WeakMap()),
          (_App_input = new WeakMap()),
          (_App_displayIpAddress = new WeakMap()),
          (_App_displayLocation = new WeakMap()),
          (_App_displayTimezone = new WeakMap()),
          (_App_displayISP = new WeakMap()),
          (_App_instances = new WeakSet()),
          (_App_loadMap = function _App_loadMap(
            ...
            // @ts-ignore
            L.marker([lat, lng], {
              icon: __classPrivateFieldGet(this, _App_icon, "f"),
            }).addTo(__classPrivateFieldGet(this, _App_map, "f"));
          }),
          ...
          (_App_trackIpAddress = function _App_trackIpAddress() {
            (0, _dataJs.getInitialAddress)().then((res) => {
              ...
              __classPrivateFieldGet(this, _App_displayISP, "f").innerText =
                isp;
              __classPrivateFieldGet(
                this,
                _App_displayTimezone,
                "f"
              ).innerText = `UTC ${timezone}`;
            });
            __classPrivateFieldGet(this, _App_form, "f").addEventListener(
              "submit",
              (e) =>
                __awaiter(this, void 0, void 0, function* () {
                  e.preventDefault();
                  const ipAddress = __classPrivateFieldGet(
                    this,
                    _App_input,
                    "f"
                  ).value;
                  __classPrivateFieldGet(this, _App_input, "f").value = "";
                  const data = yield (0, _dataJs.getAddress)(ipAddress);
                  // @ts-ignore
