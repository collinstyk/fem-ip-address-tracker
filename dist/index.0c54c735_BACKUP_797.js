...
_App_map = new WeakMap(), _App_mapZoomLevel = new WeakMap(), _App_maxZoomLevel = new WeakMap(), _App_form = new WeakMap(), _App_input = new WeakMap(), _App_displayIpAddress = new WeakMap(), _App_displayLocation = new WeakMap(), _App_displayTimezone = new WeakMap(), _App_displayISP = new WeakMap(), _App_instances = new WeakSet(), _App_loadMap = function _App_loadMap(position /*subject to change*/ ) {
    ...
    // @ts-ignore
    __classPrivateFieldSet(this, _App_map, L.map("map").setView([
        lat,
        lng
    ], __classPrivateFieldGet(this, _App_mapZoomLevel, "f")), "f");
    // @ts-ignore
...
},{"./data.js":"7TDfV"}],"7TDfV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAddress", ()=>getAddress);
parcelHelpers.export(exports, "getInitialAddress", ()=>getInitialAddress);
var __awaiter = undefined && undefined.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
            resolve(value);
...
function getAddress(ipAddress) {
    return __awaiter(this, void 0, void 0, function*() {
        try {
            ...
            alert(`${err.message} ${err.message === "Failed to fetch" ? ", this could be due to bad network \u26A0." : ""}`);
        }
    });
}
...
},{}]},["47nIX","iI2BD"], "iI2BD", "parcelRequireed6f")
